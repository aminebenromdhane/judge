...
public class OCRPDFController {
	...
	@RequestMapping(value = "ocrpdf/start",method = RequestMethod.GET)
	public void start(@RequestParam(value = "numberThread") int numberThread) {
		
		SFScraperPDF downloader = new SFScraperPDF(actionCaseService,civilCaseService,documentService,numberThread);
		downloader.ocr();
